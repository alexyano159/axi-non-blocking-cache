...
# generated artifact (work/, modelsim.ini, vsim.wlf) inside sim/
# instead of the project root.
#
# Usage: ./sim/run.sh   (from anywhere -- paths are resolved relative
...
export LM_LICENSE_FILE="$PROJECT_ROOT/LR-180454_License.dat"
